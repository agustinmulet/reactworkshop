...
`exports.handler` y afuera del `if` nos guardamos la URL de la petición a apixu
en una constante:
...
hacer el `request.get` a la API de apixu, es decir, el JSON que antes obteníamos
